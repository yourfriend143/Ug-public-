...
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://sastadeveloper65:aLocXnM5Vor9df1K@cluster0.9nmqyoa.mongodb.net/")
MONGO_URL = DATABASE_URL  # For auth system

# Owner and Admin Configuration
OWNER_ID = int(os.environ.get("OWNER_ID", "6481888008"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "6481888008").split()]  # Default to owner ID
